...
def main(fit_intercept: bool, registered_model_name: str):
    ...
    try:
        ...
        with mlflow.start_run(experiment_id=experiment_id) as run: # <--- CAMBIO CLAVE
            ...
            mlflow.set_tag("dataset", "datos.gov.co")
            mlflow.set_tag("autor", "Diego Alfaro")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Entrenamiento y registro de modelo con LSTM con MLflow")
    parser.add_argument("--fit_intercept", type=bool, default=True, help="Usar o no intercepto en el modelo")
    parser.add_argument("--model_name", type=str, default="LSTM TRM", help="Nombre del modelo en el MLflow Model Registry")
